...
void I2C_ResetI2C(void)
{
	...
	I2C_I2CIR_I2CIF_Clr(); //清中断标志
	result = I2C_I2CBUF_Read();//清接收完成标志
	I2C_I2CERR_OIERR_Clr();		//清I2C错误标志
	I2C_I2CERR_SDERR_Clr();
	I2C_I2CERR_IERR_Clr();
	I2C_I2CCTRL_SCLHL_Setable(ENABLE);//当I2C模块禁止时SCL,SDA固定高电平
	I2C_I2CCTRL_SDAHL_Setable(ENABLE);
	I2C_I2CCTRL_I2CEN_Setable(DISABLE);//关闭I2C
