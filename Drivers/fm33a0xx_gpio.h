...
#define	GPIO_ANASEL_PE3ANS_ACMP2_INN1	(0x0U << GPIO_ANASEL_PE3ANS_Pos)	/* 0：选择作为ACMP2_INN1 */
...
#define	GPIO_ANASEL_PC15ANS_ACMP2_INP0	(0x0U << GPIO_ANASEL_PC15ANS_Pos)	/* 0：选择作为ACMP2_INP0 */
