...
typedef struct
{
	...
	uint32_t CHxRAMAD;          //CH0~CH7通道RAM指针地址,
								//注意1：DMA的CH4必须使用半字对齐的地址(也就是偶数结尾的地址)，可使用__align(4) uint08 Buf[]的方法定义存储在4字节对齐的地址的缓冲区
								//注意2：DMA的CH7使用的是word地址，驱动里已处理过了，可直接输入字对齐的byte地址，可使用__align(4) uint08 Buf[]的方法定义存储在字对齐(4字节对齐)的地址的缓冲区
...
#define	DMA_CH7FLSAD_CH7FLSAD_Msk	(0x1ffffU << DMA_CH7FLSAD_CH7FLSAD_Pos)

#define	DMA_CH7RAMAD_CH7RAMAD_Pos	0	/* Channel7RAM字指针地址 */
#define	DMA_CH7RAMAD_CH7RAMAD_Msk	(0x3fffU << DMA_CH7RAMAD_CH7RAMAD_Pos)
